...
@onready var window_mode_option_button = $MarginContainer/PanelContainer/MarginContainer/VSeparator/WindowModeOptionButton
@onready var resolution_option_button = $MarginContainer/PanelContainer/MarginContainer/VSeparator/ResolutionOptionButton
...
var resolutions: Dictionary = {"480x270": Vector2i(480, 270),
							  ...
							  "845x480": Vector2i(845, 480),
							  "1280x720": Vector2i(1280, 720)}


func _ready():
	for window in window_modes:
		window_mode_option_button.add_item(window)
