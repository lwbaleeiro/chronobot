...
@export var heart_texture_0: Texture2D
@export var heart_texture_1: Texture2D
...
func on_player_health_changed(player_current_health: int):
	if player_current_health == 3:
		heart_3.texture = heart_texture_1
	elif player_current_health < 3:
		heart_3.texture = heart_texture_0

	if player_current_health == 2:
		heart_2.texture = heart_texture_1
	elif player_current_health < 2:
		heart_2.texture = heart_texture_0

	if player_current_health == 1:
		heart_1.texture = heart_texture_1
	elif player_current_health < 1:
		heart_1.texture = heart_texture_0
